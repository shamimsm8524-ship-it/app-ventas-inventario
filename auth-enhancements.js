(()=>{
  ...
  ready(()=>{
    const wait=setInterval(()=>{
      ...
      if(!document.getElementById('vaResendBtn')){
        ...
        resend.onclick=async()=>{
          ...
          try{
            ...
            if(error)throw error;
            if(msg){msg.textContent='Solicitud enviada. Si tu correo aún no está verificado, recibirás un nuevo enlace.';msg.className='va-msg ok'}
      ...
      sb.auth.onAuthStateChange(()=>setTimeout(checkGooglePassword,150));
